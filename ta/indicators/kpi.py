...
class Indicator(object):
    ...
    def get_value(self, date, field):
        if self.data_set and field in self.data_set.data_frame and date in self.data_set.data_frame[field]:
            return self.data_set.data_frame[field][date]
        else:
            self.calc()
            return self.data_set.data_frame[field][date]
...
class MovingAverage(Indicator):
    def __init__(self, data_set, period, field, id=None):
        self.period = period
        self.field = field
        super(MovingAverage, self).__init__(data_set, id)
...
class SMA(MovingAverage):
    ...
    def calc(self):
        self.data_set.data_frame['MA{}'.format(self.period)] = talib.SMA(self.data_set.data_frame[self.field].values,
                                                                         self.period)
        return self.data_set

    def __str__(self):
        return "MA%d" % self.period
...
class EMA(MovingAverage):
    ...
    def calc(self):
        self.data_set.data_frame['EMA{}'.format(self.period)] = talib.EMA(self.data_set.data_frame[ADJ_CLOSE].values,
                                                                          self.period)
        return self.data_set
